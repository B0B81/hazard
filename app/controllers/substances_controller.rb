...
private
  ...
  def substance_params
    params.require(:substance).permit(:title, :company_id, :date, :application, :protectionlevel, :signalword, :unnumber, :hazardcode, :classificationcode, :packinggroup, :transportcategory, :qmax, :inhalation, :dermale, hphrase_ids:[], pphrase_ids:[], rphrase_ids:[], hazard_symbol_ids:[], ghs_symbol_ids:[])
  end
end
